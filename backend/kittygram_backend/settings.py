...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'kittygram128.duckdns.org,localhost,158.160.29.126,127.0.0.1').split(',')
...
ALLOWED_HOSTS = os.getenv(
    'ALLOWED_HOSTS',
    'kittygram128.duckdns.org,localhost,158.160.29.126,127.0.0.1'
).split(',')
